...
const LoginComponenet = ({authenticateUser, authenticated}) => {
  return <div className="card p3 col-6">
    <h2>Please Login</h2>
...
export const ConnectedLogin = connect(mapStateToProps, mapDispatchToProps)(LoginComponenet);
