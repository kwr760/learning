...
function Nav(props) {
  return (
    <div className={props.css.root} >
      <button key="prev" className={getPrevClassName(props)} onClick={props.onPrevious}>&#10094;</button>
      <button key="next" className={getNextClassName(props)} onClick={props.onNext}>&#10095;</button>
    </div>
  )
}
